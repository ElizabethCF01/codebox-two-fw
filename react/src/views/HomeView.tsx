...
export default function HomeView() {
  ...
  const handleLoadMore = async (nextPage: number) => {
    ...
    setProjects((prevProjects) =>
      nextPage === 1 ? response.list : [...prevProjects, ...response.list],
    );
  ...
  return (
    <main className="flex-1 p-4 lg:p-10 flex flex-col items-center">
      <section className="py-12 w-full md:py-24 lg:py-32 bg-gradient-to-b from-background via-background/80 to-background flex justify-center">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4 pb-8">
            ...
            <p className="max-w-[700px] text-muted-foreground md:text-xl text-center text-pretty">
              Discover, copy and customize beautiful UI components. Save hours
              of development time.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center">
              ...
              <button type="button" className="gap-2 btn btn-wide btn-primary">
                Browse Components
              </button>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 w-full">
            ...
            <div className="flex items-center gap-4">
              <button type="button" className="gap-2 btn btn-outline">
          ...
          {hasMore && !isLoading && (
            <div className="flex justify-center mt-12">
              <button
                ...
                className="gap-2 btn btn-outline btn-wide"
                type="button"
              >
