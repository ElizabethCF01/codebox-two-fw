...
export default function ProjectCard({ project }: Props) {
   ...
   <script>
    ...
    return (<div
      ...
      >
        <div
          className="absolute top-2 right-2 z-10 flex gap-2 opacity-0 group-hover:opacity-100 ease-linear duration-200"
        >
          <button
        ...
        <div
          className="aspect-[4/3] overflow-hidden bg-muted/50 dark:bg-muted/80 flex items-center justify-center"
        >
          <iframe
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="avatar">
                <div
                  className="ring-primary ring-offset-base-100 w-7 ring ring-offset-2 bg-stone-800 rounded-full"
                >
                  <img
              ...
              <span className="text-xs text-muted-foreground">@{ project.author.username }</span>
            </div>
          </div>
        </div>
      </div>)
